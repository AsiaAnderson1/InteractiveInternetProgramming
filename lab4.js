...
function CalculateCommission()
{
    ...
    var salesperson_names = [Dave, Asia , Timothy];
    var decemberSales = new Array();
    var januarySales = new Array();
    var februarySales = new Array();
    var totalSales;
    for (i = 0; i<4; i++)
    {
        totalSales = decemberSales + januarySales + februarySales
    }

    console.log("The top salesperson and the top commission are" + topSalesPerson + topCommission)
    ...
    function CalculateAvgCommission()
    {
        AvgCommission = TotalCommission / 3;
        console.log(salesperson_names[i]);
        console.log(Commission + AvgCommission);
